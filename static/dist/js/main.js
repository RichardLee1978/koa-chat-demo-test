...
/***/ function(module, exports, __webpack_require__) {
	...
	var _routers = __webpack_require__(59);
	...
	var _fastclick = __webpack_require__(73);
	...
	(0, _keys2.default)(_index2.default).forEach(function (key) {
	    ...
	    _vue2.default.component('lj' + name, _index2.default[key]);
	});
	var route = new _vueRouter2.default({
	    routes: _routers2.default
	});
	_fastclick2.default.attach(document.body);
	new _vue2.default({ router: route }).$mount('#app');
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = { header: _header2.default, footer: _footer2.default, content: _content2.default };
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  var id = "E:\\project\\koa\\chat-koa\\static\\src\\components\\header\\header.vue"
	  if (!module.hot.data) {
...
/***/ function(module, exports) {
	...
	module.exports = "\n\t<header class=\"chat-header\" _v-c50c6e1a=\"\">\n\t\t<i _v-c50c6e1a=\"\"></i>\n\t\t<i _v-c50c6e1a=\"\">链集</i>\n\t\t<i _v-c50c6e1a=\"\"></i>\n\t</header>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\koa\\chat-koa\\static\\src\\components\\footer\\footer.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n\t<footer class=\"chat-footer\" _v-9afa859a=\"\">\n\t\t<input type=\"text\" _v-9afa859a=\"\">\n\t\t<button _v-9afa859a=\"\">提交</button>\n\t</footer>\n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\koa\\chat-koa\\static\\src\\components\\content\\content.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _socketIoClient = __webpack_require__(30);

	var _socketIoClient2 = _interopRequireDefault(_socketIoClient);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var Socket = (0, _socketIoClient2.default)(); // <style lang="less" >
	        ...
	        function s(o, u) {
	            ...
	            (function (global) {
	                var transports = _dereq_("./transports");var Emitter = _dereq_("component-emitter");var debug = _dereq_("debug")("engine.io-client:socket");var index = _dereq_("indexof");var parser = _dereq_("engine.io-parser");var parseuri = _dereq_("parseuri");var parsejson = _dereq_("parsejson");var parseqs = _dereq_("parseqs");module.exports = Socket;function noop() {}function Socket(uri, opts) {
	                    if (!(this instanceof Socket)) return new Socket(uri, opts);opts = opts || {};if (uri && "object" == (typeof uri === "undefined" ? "undefined" : (0, _typeof3.default)(uri))) {
	                        opts = uri;uri = null;
	                    }if (uri) {
	                    ...
	                    }this.pfx = opts.pfx || null;this.key = opts.key || null;this.passphrase = opts.passphrase || null;this.cert = opts.cert || null;this.ca = opts.ca || null;this.ciphers = opts.ciphers || null;this.rejectUnauthorized = opts.rejectUnauthorized === undefined ? null : opts.rejectUnauthorized;var freeGlobal = (typeof global === "undefined" ? "undefined" : (0, _typeof3.default)(global)) == "object" && global;if (freeGlobal.global === freeGlobal) {
	                        if (opts.extraHeaders && (0, _keys2.default)(opts.extraHeaders).length > 0) {
	            ...
	            module.exports = _keys2.default || function keys(obj) {
	            ...
	            (function (global) {
	                var isArray = _dereq_("isarray");module.exports = hasBinary;function hasBinary(data) {
	                    function _hasBinary(obj) {
	                        ...
	                        } else if (obj && "object" == (typeof obj === "undefined" ? "undefined" : (0, _typeof3.default)(obj))) {
	                            if (obj.toJSON) {
	                                obj = obj.toJSON();
	                            }for (var key in obj) {
	            ...
	            (function (global) {
	                (function (root) {
	                    var freeExports = (typeof exports === "undefined" ? "undefined" : (0, _typeof3.default)(exports)) == "object" && exports;var freeModule = (typeof module === "undefined" ? "undefined" : (0, _typeof3.default)(module)) == "object" && module && module.exports == freeExports && module;var freeGlobal = (typeof global === "undefined" ? "undefined" : (0, _typeof3.default)(global)) == "object" && global;if (freeGlobal.global === freeGlobal || freeGlobal.window === freeGlobal) {
	                        root = freeGlobal;
	                    ...
	                    }var utf8 = { version: "2.0.0", encode: utf8encode, decode: utf8decode };if (typeof define == "function" && (0, _typeof3.default)(define.amd) == "object" && define.amd) {
	                        define(function () {
	                            return utf8;
	                        });
	            ...
	            var url = _dereq_("./url");var parser = _dereq_("socket.io-parser");var Manager = _dereq_("./manager");var debug = _dereq_("debug")("socket.io-client");module.exports = exports = lookup;var cache = exports.managers = {};function lookup(uri, opts) {
	                if ((typeof uri === "undefined" ? "undefined" : (0, _typeof3.default)(uri)) == "object") {
	            ...
	            var eio = _dereq_("engine.io-client");var Socket = _dereq_("./socket");var Emitter = _dereq_("component-emitter");var parser = _dereq_("socket.io-parser");var on = _dereq_("./on");var bind = _dereq_("component-bind");var debug = _dereq_("debug")("socket.io-client:manager");var indexOf = _dereq_("indexof");var Backoff = _dereq_("backo2");var has = Object.prototype.hasOwnProperty;module.exports = Manager;function Manager(uri, opts) {
	                if (!(this instanceof Manager)) return new Manager(uri, opts);if (uri && "object" == (typeof uri === "undefined" ? "undefined" : (0, _typeof3.default)(uri))) {
	                    opts = uri;uri = undefined;
	            ...
	            (function (global) {
	                var isArray = _dereq_("isarray");var isBuf = _dereq_("./is-buffer");exports.deconstructPacket = function (packet) {
	                    var buffers = [];var packetData = packet.data;function _deconstructPacket(data) {
	                        ...
	                        } else if ("object" == (typeof data === "undefined" ? "undefined" : (0, _typeof3.default)(data)) && !(data instanceof Date)) {
	                    ...
	                    var curPlaceHolder = 0;function _reconstructPacket(data) {
	                        ...
	                        } else if (data && "object" == (typeof data === "undefined" ? "undefined" : (0, _typeof3.default)(data))) {
	                            for (var key in data) {
	                    ...
	                    function _removeBlobs(obj, curKey, containingObject) {
	                        ...
	                        } else if (obj && "object" == (typeof obj === "undefined" ? "undefined" : (0, _typeof3.default)(obj)) && !isBuf(obj)) {
	                            for (var key in obj) {
	            ...
	            (function (global) {
	                (function () {
	                    var isLoader = typeof define === "function" && define.amd;var objectTypes = { "function": true, object: true };var freeExports = objectTypes[typeof exports === "undefined" ? "undefined" : (0, _typeof3.default)(exports)] && exports && !exports.nodeType && exports;var root = objectTypes[typeof window === "undefined" ? "undefined" : (0, _typeof3.default)(window)] && window || this,
	                        freeGlobal = freeExports && objectTypes[typeof module === "undefined" ? "undefined" : (0, _typeof3.default)(module)] && module && !module.nodeType && (typeof global === "undefined" ? "undefined" : (0, _typeof3.default)(global)) == "object" && global;if (freeGlobal && (freeGlobal["global"] === freeGlobal || freeGlobal["window"] === freeGlobal || freeGlobal["self"] === freeGlobal)) {
	                        root = freeGlobal;
	                        ...
	                        context || (context = root["Object"]());exports || (exports = root["Object"]());var Number = context["Number"] || root["Number"],
	                            ...
	                            nativeJSON = context["JSON"] || root["JSON"];if ((typeof nativeJSON === "undefined" ? "undefined" : (0, _typeof3.default)(nativeJSON)) == "object" && nativeJSON) {
	                            ...
	                            var functionClass = "[object Function]",
	                                ...
	                                var size = 0,
	                                    ...
	                                    members = ["valueOf", "toString", "toLocaleString", "propertyIsEnumerable", "isPrototypeOf", "hasOwnProperty", "constructor"];_forEach = function forEach(object, callback) {
	                                        var isFunction = getClass.call(object) == functionClass,
	                                            property,
	                                            length;var hasProperty = !isFunction && typeof object.constructor != "function" && objectTypes[(0, _typeof3.default)(object.hasOwnProperty)] && object.hasOwnProperty || _isProperty;for (property in object) {
	                                ...
	                                var Escapes = { 92: "\\\\", 34: '\\"', 8: "\\b", 12: "\\f", 10: "\\n", 13: "\\r", 9: "\\t" };var leadingZeroes = "000000";var toPaddedString = function toPaddedString(width, value) {
	                                    ...
	                                    } catch (exception) {}if ((typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value)) == "object" && value) {
	                                    ...
	                                    var whitespace, callback, properties, className;if (objectTypes[typeof filter === "undefined" ? "undefined" : (0, _typeof3.default)(filter)] && filter) {
	                                ...
	                                var fromCharCode = String.fromCharCode;var Unescapes = { 92: "\\", 34: '"', 47: "/", 98: "\b", 116: "	", 110: "\n", 102: "\f", 114: "\r" };var Index, Source;var abort = function abort() {
	                                    ...
	                                    var value = source[property],
	                                        length;if ((typeof value === "undefined" ? "undefined" : (0, _typeof3.default)(value)) == "object" && value) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _ServiceRoom = __webpack_require__(64);
	...
	var routers = [{
	    path: '/ServiceRoom',
	    name: 'ServiceRoom',
	    component: _ServiceRoom2.default
	}, {
	    path: '/',
	    name: 'index',
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\koa\\chat-koa\\static\\src\\pages\\index.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports) {
	...
	module.exports = "\n<section class=\"container\" _v-6e521f4d=\"\">\n\t<lj-header _v-6e521f4d=\"\"></lj-header>\n\t<lj-content _v-6e521f4d=\"\"></lj-content>\n    \n</section>\n  \n    \n";
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), true)
	  if (!hotAPI.compatible) return
	  var id = "E:\\project\\koa\\chat-koa\\static\\src\\pages\\ServiceRoom.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
