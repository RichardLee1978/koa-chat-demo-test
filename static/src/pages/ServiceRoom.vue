...
<section class="container">
	<div class="chat-content-wrapper">
		<div class="chat-content"  v-if="chatMSG.length > 0">
			<span :id="'client_'+msg.say.id" v-for="msg in chatMSG " :class="{own:msg.type===1,others:msg.type===2}"><strong>{{msg.time}}</strong><br/> <em>{{msg.say}}</em></span>
           ...
           let _this = this;
        	//监听service消息
   			Socket.on("client output",function(data) {
  				   //this.$cookie.get('access_');
  					//console.log('access_: ',this.$cookie.get('access_'));
		        	var msg = {
